...
# Legacy MessageBus class removed - use Redis-based MessageBus from message_bus.py
# For agent communication, use:
# - from message_bus import MessageBus, AgentCommunicator  
# - AgentMessage, MessageType, MessagePriority classes (above)
# - create_task_assignment() function (above)